# Figures Drawing Application

**Figures Drawing Application** is a **Windows Forms project** written in C#.  
The program allows users to **create, display, manipulate, resize, move, and save** various 2D and 3D geometric figures.  
